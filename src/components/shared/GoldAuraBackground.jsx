...
<<<<<<< HEAD
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(245,200,80,0.1) 0%, transparent 60%)",
          filter: "blur(50px)",
          animation: "gold-glow-pulse 9s ease-in-out 1.5s infinite",
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(212,175,55,0.09) 0%, transparent 60%)",
          filter: "blur(55px)",
          animation: "gold-glow-pulse 11s ease-in-out 0.5s infinite",
      ...
      <div
        ...
        style={{
          ...
          background: "radial-gradient(circle, rgba(245,166,35,0.08) 0%, transparent 55%)",
          filter: "blur(45px)",
